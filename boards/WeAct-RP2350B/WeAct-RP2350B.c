// WeAct RP2350B CoreBoard_EMUZ80: Z80 bus emulator for WeAct RP2350B CoreBoard
...
int main() {
  ...
  // printf("WeAct RP2350B CoreBoard Core:1.3V Clock:360MHz\n");
  // printf("WeAct RP2350B CoreBoard Core:1.3V Clock:400MHz\n");
  ...
  // CLK PWM Setup, WeAct RP2350B CoreBoard 400MHz Z80 11MHz, 150MHz 5MHz
